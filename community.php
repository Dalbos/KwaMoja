...
?>
		...
		<div class="content">
			...
			<p>Developers have a <a href="">Mailing List</a> to discuss technical issues. It is our experience that developers tend to prefer mailing lists. There are <a href="http://forums.<i>KwaMoja</i>.org"  target="_blank">Forums</a> for discussions on a variety of topics. There is a <a href="http://wiki.<i>KwaMoja</i>.org"  target="_blank">Wiki</a> where users and developers can make notes, and share ideas, follow us on <a href="https://twitter.com/<i>KwaMoja</i>" target="_blank">twitter</a>, or if you just fancy a chat on any subject that takes your fancy drop into our irc chat room (#<i>KwaMoja</i> on irc.freenode.net) .</p>
